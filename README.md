...
#### 옵션 1: Chainlit UI (채팅 중심, 빠른 프로토타입)
```bash
...
**특징**:
- ✅ 채팅 중심 인터페이스
- ✅ 매 응답마다 핵심 버튼 표시 (테스트/품질/리뷰/메뉴)
- ✅ 빠른 개발 및 프로토타입

#### 옵션 2: Gradio UI (고정 UI, 완전한 커스터마이징)
```bash
...
**특징**:
- ✅ 완전히 고정된 사이드바 (항상 접근 가능)
- ✅ 자유로운 레이아웃 커스터마이징
- ✅ HuggingFace Spaces 배포 지원

> 💡 **팁**: 두 UI 모두 동일한 에이전트/도구 로직을 공유합니다. 선호하는 UI를 선택하세요!
